    ...
    <div class="row sm-12">
        <div class="col-md">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('user.alter') }}" method="post" name="form" id="form" class="needs-validation form" novalidate enctype="multipart/form-data">
                        ...
                        <div class="row g-6">
                            <div class="col-md-6">
                                <div class="form-floating form-floating-outline">
                                    <input type="text" name="firstname" id="firstname" class="form-control" value="{{ $data->firstname, @old('firstname') }}" />
                            ...
                            <div class="col-md-6">
                                <div class="form-floating form-floating-outline">
                                    <input type="text" name="lastname" id="lastname" class="form-control" value="{{ $data->lastname, @old('lastname') }}" />
                            ...
                            <div class="col-md-6">
                                <div class="form-floating form-floating-outline">
                                    <input type="text" name="username" id="username" class="form-control" value="{{ $data->username, @old('username') }}" />
                            ...
                            <div class="col-md-6">
                                <div class="form-floating form-floating-outline">
                                    <input type="email" name="email" id="email" class="form-control" value="{{ $data->email, @old('email') }}" />
                            ...
                            <div class="col-md-6">
                                <div class="form-floating form-floating-outline">
                                    <input type="text" name="phone" id="phone" class="form-control" value="{{ $data->phone, @old('phone') }}" />
